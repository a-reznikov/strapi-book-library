...
export interface ApiBookBook extends Schema.CollectionType {
  ...
  attributes: {
    ...
    year: Attribute.String & Attribute.Required & Attribute.DefaultTo<'2024'>;
    ...
    content: Attribute.DynamicZone<
      ['common.text-content', 'common.picture', 'common.chapter']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiUserBookUserBook extends Schema.CollectionType {
  ...
  attributes: {
    ...
    availableUntil: Attribute.DateTime;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::user-book.user-book',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::user-book.user-book': ApiUserBookUserBook;
    }
  }
}
